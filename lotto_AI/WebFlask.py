...
def repjson(tdate,model):
    ...
    pred, err_rat, lastfit_date, pred_date = pred_lottonumber(model, "current_lotto_08.09.csv",
                                                              tdate,timstep)
    #tardata to json
    testdata = {"pred": pred, "err_rat": err_rat,"lastfit_date":lastfit_date,"pred_date":pred_date}
